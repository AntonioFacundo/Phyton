...
class Interfaz:
	...
	def __init__(self, contenedor):
		...
		self.e1 = Label(contenedor, text = "Convertir grados Celcuis a Fahrenheit", fg = "black")
		self.e2 = Label(contenedor, text = "Celcius", fg = "black")
		self.e3 = Label(contenedor, text = "Fahrenheit", fg = "black")
	
		self.e4 = Button(contenedor, text = "Convertir", fg = "black", bg = "cyan", command = self.hacer_conversion)
